...
// SAFETY_SWITCH_OPEN
#define SAFETY_SWITCH_OPEN_1  "+------------------+\0"
#define SAFETY_SWITCH_OPEN_2  "|Tapa de seguridad |\0"
#define SAFETY_SWITCH_OPEN_3  "|     abierta      |\0"
#define SAFETY_SWITCH_OPEN_4  "+------------------+\0"
...
const lcd_msg lcd_text [] = {
	...
	{SAFETY_SWITCH_OPEN_1, SAFETY_SWITCH_OPEN_2, SAFETY_SWITCH_OPEN_3, SAFETY_SWITCH_OPEN_4}
};
